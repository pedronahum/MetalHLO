// Auto-bundled from MLX (mlx-swift Cmlx mlx-generated/gemm_nax.cpp).
// Flattened metal source for the NAX cooperative-tensor GEMM dependency chain:
// defines / utils / transforms / type_traits / integral_constant / nax.h /
// params / gemm_nax (gemm_loop). Appended with a thin wrapper kernel that uses
// our buffer ABI (A=0,B=1,C=2,M=3,N=4,K=5). Reaches MLX-grade tf32 throughput
// on M5's matrix coprocessor. Do not hand-edit — regenerate from MLX source.
enum NAXGemmBundle {
