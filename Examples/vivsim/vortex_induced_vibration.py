"""
Vortex-Induced Vibration (VIV) of a circular cylinder using IB-LBM — MetalHLO backend test
...
if PLOT:
    ...
    plt.suptitle("VIV Simulation (MetalHLO backend)")
    plt.tight_layout()
...
fig.suptitle("VIV Results (MetalHLO backend)")
fig.tight_layout()
plt.show()
