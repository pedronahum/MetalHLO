"""
Poiseuille flow in a 2D channel driven by a constant body force using LBM — MetalHLO backend test
...
plt.xlabel('$y$')
plt.ylabel('$u_x$')
plt.title('Poiseuille flow in a channel (MetalHLO backend)')
plt.show()
